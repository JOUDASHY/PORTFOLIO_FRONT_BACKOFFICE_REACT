...
>
    <div className="modal-body text-center">
        ...
        <div className="modal-footer justify-content-center">
            <button className="btn-jaune" onClick={() => DeleteAward(selectedAward?.id)}>
      ...
      filteredAward.map(Award => (
        <tr key={Award.id}>
          ...
          <td className="align-middle">
            <button className="btn-blue me-2" onClick={() => handleEditClick(Award)}>
              <i className="fas fa-edit"></i>
            </button>
            <button className="btn-jaune" onClick={() => openDeleteModal(Award)}>
