...
const Header = ({user,setUser,setToken}) => {
  ...
  // Add toggle function for profile dropdown
  const toggleProfileDropdown = (e) => {
    e.preventDefault();
    setIsProfileOpen(!isProfileOpen);
  };

  // Add useEffect for handling clicks outside profile dropdown
  useEffect(() => {
        ...
        View all
            ...
            <li className="dropdown pc-h-item header-user-profile">
              ...
              <div
                ...
                className={`dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown ${isProfileOpen ? 'show' : ''}`}
